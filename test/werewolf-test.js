...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    // your code here
    var werewolf = new Werewolf('Lousia', 'Basement lair');

    assert.equal(werewolf.hunger, false);
  });
  ...
  it('should become hungry after changing into werewolf form', function() {
    ...
    werewolf.change();
    assert.equal(werewolf.hunger, true);
  });

  it('should be able to eat(victim) once hungry', function() {
    // your code here
    var werewolf = new Werewolf('Lousia', 'Basement lair');
    var victim = new Victim('Kyle');
    ...
    assert.equal(werewolf.hunger, true);
    werewolf.eat(victim);
    assert.equal(werewolf.victims[0], victim);
  });
